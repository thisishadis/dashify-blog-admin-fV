...
export default function AllPosts() {
  ...
  const {
    ...
    queryKey: ["products", searchParams.get("page") || 1],
    queryFn: () =>
      fetchProducts(50, ((searchParams.get("page") || 1) - 1) * 50),
  });
...
//     queryKey: ["products", searchParams.get("page") || 1],
//     queryFn: () => fetchProducts(50, ((searchParams.get("page") || 1) - 1) * 50),
//   });

//   const deletePost = useMutation(deleteProduct, {
//     onSuccess: () => {
//       toast.success(`Product with ID ${ID} deleted successfully.`);
//       refetch();
//     },
...
//           <div className="modal-action">
//             <form method="dialog" className="flex w-full items-center justify-between">
//               <button className="btn btn-outline btn-error">NO</button>
//               <button
//                 onClick={() => {
//                   console.log("clicked");
